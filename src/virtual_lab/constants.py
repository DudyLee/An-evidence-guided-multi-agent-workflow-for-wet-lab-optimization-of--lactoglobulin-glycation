...
# Prices in USD as of March 4, 2026 (https://openai.com/api/pricing/)
MODEL_TO_INPUT_PRICE_PER_TOKEN = {
    ...
    "gpt-4.1-2025-04-14": 2 / 10**6,
    "gpt-5.2-2025-12-11": 1.75 / 10**6,
    "gpt-5.4-2026-03-05": 2.5 / 10**6,
    "openai/gpt-5.4": 2.5 / 10**6
}

MODEL_TO_CACHED_INPUT_PRICE_PER_TOKEN = {
    "gpt-5.2-2025-12-11": 0.175 / 10**6,
    "gpt-5.4-2026-03-05": 0.25 / 10**6,
    "openai/gpt-5.4": 0.25 / 10**6
}
...
MODEL_TO_OUTPUT_PRICE_PER_TOKEN = {
    ...
    "gpt-4.1-2025-04-14": 8 / 10**6,
    "gpt-5.2-2025-12-11": 14 / 10**6,
    "gpt-5.4-2026-03-05": 15 / 10**6,
    "openai/gpt-5.4": 15 / 10**6
}
