...
DEBUG_PROMPT = "This script needs to be improved. Please read the error messages from the previous attempt to run the script and fix all errors in the script without changing anything else."

RESEARCHER_GUIDE_PROMPT = "You have decided to implement the tools with the help of the human researcher. Please provide a step-by-step guide for the human researcher to implement the tools. The guide should be detailed and specific, but also simple and easy to follow. The guide should not include any code; it should only include instructions for the human researcher to follow."
